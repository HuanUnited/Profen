...
type NodeQuery struct {
	...
	withChildClosures        *NodeClosureQuery
...
// QueryChildClosures chains the current query on the "child_closures" edge.
func (_q *NodeQuery) QueryChildClosures() *NodeClosureQuery {
	query := (&NodeClosureClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
// QueryParentClosures chains the current query on the "parent_closures" edge.
func (_q *NodeQuery) QueryParentClosures() *NodeClosureQuery {
	query := (&NodeClosureClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
...
func (_q *NodeQuery) QueryOutgoingAssociations() *NodeAssociationQuery {
	query := (&NodeAssociationClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (_q *NodeQuery) QueryIncomingAssociations() *NodeAssociationQuery {
	query := (&NodeAssociationClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
...
func (_q *NodeQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *NodeQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (_q *NodeQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *NodeQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (_q *NodeQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (_q *NodeQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *NodeQuery) Clone() *NodeQuery {
	...
	return &NodeQuery{
		...
		withChildClosures:        _q.withChildClosures.Clone(),
...
// WithChildClosures tells the query-builder to eager-load the nodes that are connected to
// the "child_closures" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *NodeQuery) WithChildClosures(opts ...func(*NodeClosureQuery)) *NodeQuery {
	query := (&NodeClosureClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withChildClosures = query
	return _q
}

// WithParentClosures tells the query-builder to eager-load the nodes that are connected to
// the "parent_closures" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *NodeQuery) WithParentClosures(opts ...func(*NodeClosureQuery)) *NodeQuery {
	query := (&NodeClosureClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withParentClosures = query
	return _q
}
...
func (_q *NodeQuery) WithOutgoingAssociations(opts ...func(*NodeAssociationQuery)) *NodeQuery {
	query := (&NodeAssociationClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *NodeQuery) WithIncomingAssociations(opts ...func(*NodeAssociationQuery)) *NodeQuery {
	query := (&NodeAssociationClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *NodeQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Node, error) {
	...
	if query := _q.withChildClosures; query != nil {
		if err := _q.loadChildClosures(ctx, query, nodes,
			func(n *Node) { n.Edges.ChildClosures = []*NodeClosure{} },
			func(n *Node, e *NodeClosure) { n.Edges.ChildClosures = append(n.Edges.ChildClosures, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withParentClosures; query != nil {
		if err := _q.loadParentClosures(ctx, query, nodes,
			func(n *Node) { n.Edges.ParentClosures = []*NodeClosure{} },
			func(n *Node, e *NodeClosure) { n.Edges.ParentClosures = append(n.Edges.ParentClosures, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withOutgoingAssociations; query != nil {
		if err := _q.loadOutgoingAssociations(ctx, query, nodes,
			func(n *Node) { n.Edges.OutgoingAssociations = []*NodeAssociation{} },
	...
	if query := _q.withIncomingAssociations; query != nil {
		if err := _q.loadIncomingAssociations(ctx, query, nodes,
			func(n *Node) { n.Edges.IncomingAssociations = []*NodeAssociation{} },
			func(n *Node, e *NodeAssociation) {
...
func (_q *NodeQuery) loadChildClosures(ctx context.Context, query *NodeClosureQuery, nodes []*Node, init func(*Node), assign func(*Node, *NodeClosure)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*Node)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(nodeclosure.FieldAncestorID)
	}
	query.Where(predicate.NodeClosure(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(node.ChildClosuresColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		...
		node, ok := nodeids[fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "ancestor_id" returned %v for node %v`, fk, n.ID)
		}
		assign(node, n)
	}
	return nil
}
func (_q *NodeQuery) loadParentClosures(ctx context.Context, query *NodeClosureQuery, nodes []*Node, init func(*Node), assign func(*Node, *NodeClosure)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*Node)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(nodeclosure.FieldDescendantID)
	}
	query.Where(predicate.NodeClosure(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(node.ParentClosuresColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *NodeQuery) loadOutgoingAssociations(ctx context.Context, query *NodeAssociationQuery, nodes []*Node, init func(*Node), assign func(*Node, *NodeAssociation)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*Node)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(nodeassociation.FieldSourceID)
	}
	query.Where(predicate.NodeAssociation(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(node.OutgoingAssociationsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *NodeQuery) loadIncomingAssociations(ctx context.Context, query *NodeAssociationQuery, nodes []*Node, init func(*Node), assign func(*Node, *NodeAssociation)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*Node)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(nodeassociation.FieldTargetID)
	}
	query.Where(predicate.NodeAssociation(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(node.IncomingAssociationsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
