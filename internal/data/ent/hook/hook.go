...
// Mutate calls f(ctx, m).
func (f ErrorResolutionFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.ErrorResolutionMutation); ok {
		return f(ctx, mv)
	}
...
// function as FsrsCard mutator.
type FsrsCardFunc func(context.Context, *ent.FsrsCardMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f FsrsCardFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.FsrsCardMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.FsrsCardMutation", m)
}
...
// The NodeAssociationFunc type is an adapter to allow the use of ordinary
// function as NodeAssociation mutator.
type NodeAssociationFunc func(context.Context, *ent.NodeAssociationMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f NodeAssociationFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.NodeAssociationMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.NodeAssociationMutation", m)
}

// The NodeClosureFunc type is an adapter to allow the use of ordinary
// function as NodeClosure mutator.
type NodeClosureFunc func(context.Context, *ent.NodeClosureMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f NodeClosureFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.NodeClosureMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.NodeClosureMutation", m)
}
